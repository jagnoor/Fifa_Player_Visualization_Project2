...
d3.json("/api/top-players-network").then(function(data) {
    networkData = data;
...
d3.json("/api/club-treemap").then(function(data) {
...
d3.json("/api/wage-overall").then(function(data) {
    scatterData = data;
...
d3.json("/api/position-age").then(function(data) {
...
d3.json("/api/position-chord").then(function(data) {
...
d3.json("/api/continent-summary").then(function(data) {
...
d3.json("/api/attribute-distribution").then(function(data) {
    swarmRawData = data;
